...
public class PlayerCamera : MonoBehaviour
{
    ...
    public float verticalAirDownDeadZone; // 在空中时，相机向下跟随的死区
    ...
    [Range(0, 90)] public float verticalMaxRotation = 80; // 相机俯仰角最大值

    [Range(-90, 0)] public float verticalMinRotation = -20; // 相机俯仰角最小值
    ...
    public virtual void Reset()
    {
        ...
        m_cameraTargetYaw = player.transform.eulerAngles.y; // 根据玩家朝向设定相机水平角
