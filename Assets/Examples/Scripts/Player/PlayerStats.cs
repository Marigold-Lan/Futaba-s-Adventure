...
{
    //==============================【基础属性】==============================//
    [Header("General Stats")] public float pushForce = 4f; // 推动物体的力量
    ...
    //==============================【拾取与投掷】==============================//
    [Header("Pick'n Throw Stats")] public bool canPickUp = true; // 是否允许拾取物体
    public bool canPickUpOnAir; // 是否可以在空中拾取
    ...
    //==============================【运动属性】==============================//
    [Header("Motion Stats")] public bool applySlopeFactor = true; // 是否考虑坡度因子
    ...
    //==============================【奔跑】==============================//
    [Header("Running Stats")] public float runningAcceleration = 16f; // 奔跑加速度
    public float runningTopSpeed = 7.5f; // 奔跑最高速度
    public float runningTurningDrag = 14f; // 奔跑转向阻力

    //==============================【跳跃】==============================//
    [Header("Jump Stats")] public int multiJumps = 1; // 允许的额外跳跃次数（多段跳）
    ...
    //==============================【下蹲】==============================//
    [Header("Crouch Stats")] public float crouchHeight = 1f; // 下蹲时角色高度
    public float crouchFriction = 10f; // 下蹲时摩擦力

    //==============================【匍匐爬行】==============================//
    [Header("Crawling Stats")] public float crawlingAcceleration = 8f; // 爬行加速度
    ...
    //==============================【墙壁滑行 & 蹬墙跳】==============================//
    [Header("Wall Drag Stats")] public bool canWallDrag = true; // 是否可以贴墙滑行
    ...
    //==============================【爬杆】==============================//
    [Header("Pole Climb Stats")] public bool canPoleClimb = true; // 是否能爬杆
    ...
    //==============================【游泳】==============================//
    [Header("Swimming Stats")] public float waterConversion = 0.35f; // 水中移动系数
    ...
    //==============================【旋转攻击】==============================//
    [Header("Spin Stats")] public bool canSpin = true; // 是否可以旋转攻击
    ...
    //==============================【受伤反应】==============================//
    [Header("Hurt Stats")] public float hurtUpwardForce = 10f; // 受伤时向上的力
    public float hurtBackwardsForce = 5f; // 受伤时向后的力

    //==============================【空中俯冲】==============================//
    [Header("Air Dive Stats")] public bool canAirDive = true; // 是否能进行空中俯冲
    ...
    //==============================【踩踏攻击】==============================//
    [Header("Stomp Attack Stats")] public bool canStompAttack = true; // 是否能进行踩踏攻击
    ...
    //==============================【悬挂在边缘】==============================//
    [Header("Ledge Hanging Stats")] public bool canLedgeHang = true; // 是否可以悬挂
    ...
    //==============================【攀爬边缘】==============================//
    [Header("Ledge Climbing Stats")] public bool canClimbLedges = true; // 是否可以攀爬边缘
    ...
    //==============================【后空翻】==============================//
    [Header("Backflip Stats")] public bool canBackflip = true; // 是否能后空翻
    ...
    //==============================【铁轨滑行（Grinding）】==============================//
    [Header("Rail Grinding Stats")] public bool useCustomCollision = true; // 是否使用自定义碰撞检测
    ...
    //==============================【铁轨刹车】==============================//
    [Header("Rail Grinding Brake")] public bool canGrindBrake = true; // 是否能在滑轨时刹车
    public float grindBrakeDeceleration = 10; // 刹车减速度

    //==============================【铁轨冲刺】==============================//
    [Header("Rail Grinding Dash Stats")] public bool canGrindDash = true; // 是否能在滑轨时冲刺
