...
namespace PLAYERTWO.PlatformerProject
{
    ...
    public class UISaveCard : MonoBehaviour
    {
        ...
        [SerializeField] protected AudioClip loadClip;
        [SerializeField] protected AudioClip createClip;
        [SerializeField] protected AudioClip deleteClip;
        [Header("下一关卡场景")]
        ...
        private void InitializeAudio()
        {
            ...
            loadButton.onClick.AddListener(() => { audio.PlayOneShot(loadClip);});
            deleteButton.onClick.AddListener(() => {audio.PlayOneShot(deleteClip);});
            newGameButton.onClick.AddListener(() => { audio.PlayOneShot(createClip);});
        }
    }
}
