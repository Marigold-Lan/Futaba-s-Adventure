...
{
    public class CroakWaterBehavior : CharacterStateBase
    {
        ...
        public CroakWaterBehavior(CharacterBase context, MovementBase movement, List<Transform> targetPoints) : base(context)
        {
        ...
        private void Move()
        {
            _movement.RotateToTarget(_targetPoints[_currentPointIndex].position, b =>
            {
