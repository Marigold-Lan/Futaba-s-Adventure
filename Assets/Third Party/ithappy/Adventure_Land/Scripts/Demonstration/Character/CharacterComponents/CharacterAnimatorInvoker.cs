...
namespace ithappy.Adventure_Land
{
    public class CharacterAnimatorInvoker : MonoBehaviour
    {
        ...
        public void Hello() => OnCharacterHello?.Invoke();
        public void LeftStep() => OnCharacterLeftStep?.Invoke();
        public void RightStep() => OnCharacterRightStep?.Invoke();
        public void Jump() => OnCharacterJump?.Invoke();
    }
}
